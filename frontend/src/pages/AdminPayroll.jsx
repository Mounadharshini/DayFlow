      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24, flexWrap: 'wrap', gap: 16 }}>
        ...
        <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
          <button 
            ...
            style={{ background: 'linear-gradient(135deg, #b37a4c 0%, #9c6137 100%)', gap: 6, padding: '8px 16px' }}
          >
            <Plus size={15} /> Issue Salary Slip
          </button>
          <button className="btn-secondary btn-sm" onClick={loadData} disabled={loading} style={{ gap: 6 }}>
